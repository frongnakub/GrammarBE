...
export default class PastContinuous extends Component {
    state = {
        lessons: [],
        loading: true,
        index: 0,
    ...
    fetchLessonDetail() {
        axios.get("http://localhost:3003/pastContinuous")
        .then(res => {
                        ...
                        :
                            ...
                            <View>
                                ...
                                lessons.length === 0 ? <Text style={styles.welcome}>Try Again</Text> :
                                    <View>
                                        <View>
                                            <Text style={styles.headers}>Past Continuous Tense</Text>
                                            <View style={styles.bodyText}>
                                                <Text style={styles.headers2}>{'Structure: \nSubj. + was/were + V. ing'}</Text>
                                            </View>
                                            <Text style={styles.text}>{lessons[index].LessonDescription}</Text> 
                                        </View>
                                        <TouchableOpacity onPress={() =>  this.props.navigation.navigate('PastContinuousExercise',{username: username})}>
