...
export default class FuturePerfectContinuous extends Component {
    state = {
        lessons: [],
        loading: true,
        index: 0,
                ...
                :
                    ...
                    <View>
                        ...
                        lessons.length === 0 ? <Text style={styles.welcome}>Try Again</Text> :
                            <View>
                                <View>
                                    <Text style={styles.headers}>Future Perfect Continuous Tense</Text>
                                    <View style={styles.bodyText}>
                                        <Text style={styles.headers2}>{'Structure: \nSubj. + will/shall + have + been + V.ing'}</Text>
                                    </View>
                                    <Text style={styles.text}>{lessons[index].LessonDescription}</Text> 
                                    
                                </View>
                                <TouchableOpacity onPress={() =>  this.props.navigation.navigate('FuturePerfectContinuousExercise',{username: username})}>
