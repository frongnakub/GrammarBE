    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.headerContainer}>
          <Text style={{padding: 10,textAlign:"left",fontWeight:'400', fontSize: 16, fontFamily: 'comicsansms_bold'}}>Round 2 </Text>
                      ...
                      answer ?
                        <View>
                          {questions.length === index + 1 ? (
                            <TouchableOpacity onPress={() => this.props.navigation.navigate('ResultScreen2',{username: username})} style={styles.checkContainer}> 
