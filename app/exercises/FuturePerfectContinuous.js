...
export default class FuturePerfectContinuous extends Component {
  ...
  fetchQuestions() {
    axios.get("http://localhost:3003/futurePerfectContinuousExercise")
    .then(res => {
                      ...
                      answer ?
                        <View>
                          ...
                          {questions.length === index + 1 ? (
                            <TouchableOpacity style={styles.iconContainer} onPress={() => this.props.navigation.navigate('FuturePerfectContinuous')}>
                              <Icon
                                  name="right"
                                  color="#fff"
                                  size={20}
