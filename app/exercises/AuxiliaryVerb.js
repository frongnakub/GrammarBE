...
export default class Auxilary extends Component {
  state = {
    questions: [],
    loading: true,
    index: 0,
  ...
  fetchQuestions() {
    axios.get("http://localhost:3003/auxilaryExercise")
    .then(res => {
                      ...
                      answer ?
                        <View style={styles.bottom}>
                          ...
                          {questions.length === index + 1 ? (
                            <TouchableOpacity onPress={() => this.props.navigation.navigate('Auxilary')}>
