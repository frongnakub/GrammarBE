...
export default class PresentContinuous extends Component {
  ...
  fetchQuestions() {
    axios.get("http://localhost:3003/presentContinuousExercise")
    .then(res => {
                      ...
                      answer ?
                        <View>
                          ...
                          {questions.length === index + 1 ? (
                            <TouchableOpacity style={styles.iconContainer} onPress={() => this.props.navigation.navigate('PresentContinuous')}>
                              <Icon
                                  name="right"
                                  color="#fff"
                                  size={20}
