...
export default class PastPerfectContinuous extends Component {
  ...
  fetchQuestions() {
    axios.get("http://localhost:3003/pastPerfectContinuousExercise")
    .then(res => {
                      ...
                      answer ?
                        <View>
                          ...
                          {questions.length === index + 1 ? (
                            <TouchableOpacity style={styles.iconContainer} onPress={() => this.props.navigation.navigate('PastPerfectContinuous')}>
                              <Icon
                                  name="right"
                                  color="#fff"
                                  size={20}
